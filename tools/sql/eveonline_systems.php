...
$sql = "DROP TABLE IF EXISTS `eveonline_systems`";
$db->sql_query($sql);

// Create new eveapi_items
$sql = "CREATE TABLE `eveonline_systems` 
		(
...
// Fill new table
$sql = "INSERT INTO `eveonline_systems` (`systemID`, `systemName`)
...
$sql = "SELECT systemID, systemName
		FROM eveonline_systems
		ORDER BY systemID";
$result = $db->sql_query($sql);

echo chr(36) . "umil->table_row_insert(".chr(36)."table_prefix.'eveonline_bbcode_systems', array(\r\n";
