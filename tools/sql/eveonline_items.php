...
$sql = "DROP TABLE IF EXISTS `eveonline_items`";
$db->sql_query($sql);

// Create new eveapi_items
$sql = "CREATE TABLE `eveonline_items` (
...
// Fill new table
$sql = "INSERT INTO `eveonline_items` (`itemID`, `itemName`, `categoryID`)
...
$sql = "SELECT itemID, itemName, categoryID
		FROM eveonline_items
		ORDER BY itemID";
$result = $db->sql_query($sql);

echo chr(36) . "umil->table_row_insert(".chr(36)."table_prefix.'eveonline_bbcode_items', array(\r\n";
